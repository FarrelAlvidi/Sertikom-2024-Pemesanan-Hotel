    ...
    <header class="relative z-50 w-full h-24">
        <div
            ...
            <a href="index.php" class="relative flex items-center inline-block h-5 h-full font-black leading-none">
                ...
                <span class="ml-3 text-xl text-gray-800">ExproHotel<span class="text-pink-500">.</span></span>
            </a>
            ...
            <nav id="nav"
                ...
                <a href="#testimonials"
                    class="mr-0 font-bold duration-100 md:mr-3 lg:mr-8 transition-color hover:text-indigo-600">Testimoni</a>
                <a href="formPemesanan.php"
                    class="mr-0 font-bold duration-100 md:mr-3 lg:mr-8 transition-color hover:text-indigo-600">Reservasi</a>
    ...
    <div class="relative items-center justify-center w-full overflow-x-hidden lg:pt-40 lg:pb-40 xl:pt-40 xl:pb-64">
        <div
            ...
            <div
                ...
                <h1 class="relative mb-4 text-3xl font-black leading-tight text-gray-900 sm:text-5xl xl:mb-8">Selamat Datang di ExproHotel</h1>
                <p class="pr-0 mb-8 text-base text-gray-600 sm:text-lg xl:text-md    lg:pr-20">Selamat datang di Expro Hotel, tempat di mana kenyamanan dan kehangatan bertemu dengan
                    layanan berkualitas tinggi. Terletak di jantung Kota Bogor, kami menawarkan pengalaman
                    menginap yang tak terlupakan bagi anda.</p>
                <a href="formPemesanan.php"
    ...
    <div id="features" class="relative w-full px-8 py-10 border-t border-gray-200 md:py-16 lg:py-24 xl:py-40 xl:px-0">
        <div class="container flex flex-col items-center justify-between h-full max-w-6xl mx-auto">
            ...
            <h3
                ...
                Fasilitias Yang Kami sediakan</h3>
            <div class="flex flex-col w-full mt-0 lg:flex-row sm:mt-10 lg:mt-20">
                ...
                <div class="w-full max-w-md mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
                    <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        ...
                        <h4 class="relative mt-6 text-lg font-bold text-center">Wi-Fi Gratis dan Layanan Bisnis</h4>
                        <p class="relative mt-2 text-base text-center text-gray-600">Kami memahami pentingnya tetap terhubung, oleh
karena itu, Wi-Fi gratis tersedia di seluruh area hotel.</p>
                ...
                <div class="w-full max-w-md mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
                    <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        ...
                        <h4 class="relative mt-6 text-lg font-bold text-center">Kamar dan Suite yang Mewah</h4>
                        <p class="relative mt-2 text-base text-center text-gray-600">Setiap kamar di Expro Hotel dirancang dengan
rancangan yang modern dan dilengkapi dengan sentuhan klasik yang elegan.</p>

                    </div>
                </div>

                <div class="w-full max-w-md mx-auto mb-16 lg:mb-0 lg:w-1/3">
                    <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                        ...
                        <h4 class="relative mt-6 text-lg font-bold text-center">Kolam Renang dan Pusat Kebugaran</h4>
                        <p class="relative mt-2 text-base text-center text-gray-600">Kami menyediakan kolam renang yang menyegarkan dan pusat kebugaran
lengkap dengan peralatan terkini.</p>
    ...
    <div class="relative px-8 py-10 bg-white border-t border-gray-200 md:py-16 lg:py-24 xl:py-40 xl:px-0">
        ...
        <div id="pricing" class="container flex flex-col items-center h-full max-w-6xl mx-auto">
            <h2 class="my-5 text-base font-medium tracking-tight text-indigo-500 uppercase">Our Room</h2>
            <h3
                ...
                <div class="relative flex flex-col items-center block sm:flex-row">
                    <div
                        ...
                        <div class="overflow-hidden text-black bg-white border-t border-gray-100 rounded-lg shadow-sm">
                            <div
                                ...
                                <h3 class="p-3 text-lg font-bold tracking-wide text-center uppercase">Standard<span
                                        class="ml-2 font-light">Room</span></h3>
                                <h4
                                    class="flex items-center justify-center pb-6 text-4xl font-bold text-center text-gray-900">
                                    <span class="mr-1 -ml-2 text-lg text-gray-700">Rp.</span>800.000
</h4>
                                <p class="text-sm text-gray-600">Kamar standar kami adalah pilihan yang nyaman dan terjangkau untuk para tamu yang mencari penginapan sederhana namun berkualitas.
                                </p>
                            </div>
                            ...
                            <div class="flex items-center block p-8 uppercase">
                                <a href=""
                                    class="block w-full px-6 py-4 mt-3 text-lg font-semibold text-center text-white bg-gray-900 rounded shadow-sm hover:bg-green-600">Booking</a>
                            </div>
                        </div>
                    </div>
                    <!-- Superior Pricing -->
                    <div
                        ...
                        <div class="block max-w-sm px-8 mx-auto mt-5 text-sm text-left text-black sm:text-md lg:px-6">
                            <h3 class="p-3 pb-1 text-lg font-bold tracking-wide text-center uppercase">Superior<span
                                    class="ml-2 font-light">Room</span></h3>
                            <h4
                                class="flex items-center justify-center pb-6 text-5xl font-bold text-center text-gray-900">
                                <span class="mr-1 -ml-2 text-lg text-gray-700">Rp.</span>1.800.000</h4>
                            <p class="text-sm text-gray-600"> Didesain dengan detail yang cermat dan kenyamanan yang tak tertandingi, kamar ini menawarkan ruang yang luas dengan berbagai fasilitas tambahan.</p>
                        </div>
                        ...
                        <div class="flex items-center block p-8 uppercase">
                            <a href="#_"
                                class="block w-full px-6 py-4 mt-3 text-lg font-semibold text-center text-white bg-gray-900 rounded shadow-sm hover:bg-indigo-600">Booking</a>
                        </div>
                    </div>
                    <!-- Premium Pricing -->
                    <div
                        ...
                        <div class="overflow-hidden text-black bg-white rounded-lg shadow-lg shadow-inner">
                            <div
                                ...
                                <h3 class="p-3 pb-1 text-lg font-bold tracking-wide text-center uppercase">Deluxe<span
                                        class="ml-2 font-light">Room</span></h3>
                                <h4
                                    class="flex items-center justify-center pb-6 text-4xl font-bold text-center text-gray-900">
                                    <span class="mr-1 -ml-2 text-lg text-gray-700">Rp.</span>1.500.000</h4>
                                <p class="pl-2 text-sm text-gray-600">Dengan ruang yang lebih luas dan perabotan yang lebih bergaya, kamar superior ini menawarkan suasana yang lebih eksklusif.</p>
                            </div>
        ...
        <div class="max-w-6xl mx-auto">
            <div class="flex-col items-center ">
                <div class="flex flex-col items-center justify-center w-full h-full max-w-2xl pr-8 mx-auto text-center">
                    <p class="my-5 text-base font-medium tracking-tight text-indigo-500 uppercase">Testimoni Pelanggan
                    </p>
                    <h2
                        class="text-4xl font-extrabold leading-10 tracking-tight text-gray-900 sm:text-5xl sm:leading-none md:text-6xl lg:text-5xl xl:text-6xl">
                        Guest Comments</h2>
                    <p class="my-6 text-xl font-medium text-gray-500"></p>
                ...
                <div class="flex flex-col items-center justify-center max-w-2xl py-8 mx-auto xl:flex-row xl:max-w-full">
                    <div class="w-full xl:w-1/2 xl:pr-8">
                        <blockquote
                            class="shadow-lg flex flex-col-reverse items-center justify-between w-full col-span-1 p-6 text-center transition-all duration-200 bg-gray-100 rounded-lg md:flex-row md:text-left hover:bg-white hover:shadow ease">
                            <div class="flex flex-col pr-8">
                                <div class="relative pl-12">
                                    ...
                                    <p class="mt-2 text-base text-gray-600">Pengalaman menginap di hotel ini sungguh luar biasa! Pelayanannya istimewa, kamar nyaman, dan fasilitas lengkap. Sangat direkomendasikan!
                                    </p>
                                </div>

                                <h3 class="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">Sandra
                                    Walton <span class="mt-1 text-sm leading-5 text-gray-500 truncate">- Guest
                                        </span></h3>
                        ...
                        <blockquote
                            class="shadow-lg flex flex-col-reverse items-center justify-between w-full col-span-1 p-6 mt-16 mb-16 text-center transition-all duration-200 bg-gray-100 rounded-lg md:flex-row md:text-left hover:bg-white hover:shadow ease xl:mb-0">
                            <div class="flex flex-col pr-10">
                                <div class="relative pl-12">
                                    ...
                                    <p class="mt-2 text-base text-gray-600">Saya sangat puas dengan pengalaman menginap di hotel ini! Pelayanan ramah, kamar bersih, dan fasilitas lengkap. Terima kasih atas pengalaman yang menyenangkan!</p>
                                </div>
                                <h3 class="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">Kenny
                                    Jones <span class="mt-1 text-sm leading-5 text-gray-500 truncate">- Guest
                                    </span></h3>
                                <p class="mt-1 text-sm leading-5 text-gray-500 truncate"></p>
                            </div>
                            <img class="flex-shrink-0 object-cover w-24 h-24 mb-5 bg-gray-300 rounded-full md:mb-0"
                    ...
                    <div class="w-full xl:w-1/2 xl:pl-8">
                        <blockquote
                            ...
                            <div class="flex flex-col pr-10">
                                <div class="relative pl-12">
                                    ...
                                    <p class="mt-2 text-base text-gray-600">Hotel ini sungguh luar biasa! Pelayanan yang istimewa, kamar yang nyaman, dan fasilitas lengkap membuat saya betah. Saya pasti akan kembali!
                                    </p>
                                </div>

                                <h3 class="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">Mike Smith
                                    <span class="mt-1 text-sm leading-5 text-gray-500 truncate">- Guest</span>
                                </h3>
                                <p class="mt-1 text-sm leading-5 text-gray-500 truncate"></p>
                            </div>
                            <img class="flex-shrink-0 object-cover w-24 h-24 mb-5 bg-gray-300 rounded-full md:mb-0"
                        ...
                        <blockquote
                            class="shadow-lg flex flex-col-reverse items-center justify-between w-full col-span-1 p-6 mt-16 text-center transition-all duration-200 bg-gray-100 rounded-lg md:flex-row md:text-left hover:bg-white hover:shadow ease">
                            <div class="flex flex-col pr-10">
                                <div class="relative pl-12">
                                    <svg class="absolute left-0 w-10 h-10 text-indigo-500 fill-current"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 125">
                                    ...
                                    <p class="mt-2 text-base text-gray-600">Menginap di hotel ini adalah keputusan yang tepat! Pelayanan yang ramah, kamar yang nyaman, dan fasilitas lengkap membuat pengalaman saya tak terlupakan. Sangat direkomendasikan!</p>
                                </div>

                                <h3 class="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">Molly
                                    Sanchez <span class="mt-1 text-sm leading-5 text-gray-500 truncate">- Guest</span></h3>
                                <p class="mt-1 text-sm leading-5 text-gray-500 truncate"></p>
                            </div>
                            <img class="flex-shrink-0 object-cover w-24 h-24 mb-5 bg-gray-300 rounded-full md:mb-0"
    ...
    <footer class="px-4 pt-12 pb-8 text-white bg-white border-t border-gray-200">
            ...
            <div class="block w-full pl-10 mt-6 text-sm lg:w-3/4 sm:flex lg:mt-0">
                <ul class="flex flex-col w-full p-0 font-medium text-left text-gray-700 list-none">
                    <li class="inline-block px-3 py-2 mt-5 font-bold tracking-wide text-gray-800 uppercase md:mt-0">
                        Product</li>
                    <li><a href="#_"
                            class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">Facilities</a>
                    </li>
                    <li><a href="#_"
                            class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">Room & Suites</a>
                    </li>
                    <li><a href="#_"
        ...
        <div class="pt-4 pt-6 mt-10 text-center text-gray-500 border-t border-gray-100">© 2020 EXPROHOTEL. All rights
            reserved.</div>
    </footer>
