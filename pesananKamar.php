      ...
      <div class="flex flex-col flex-1 w-full">
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container grid px-6 mx-auto">
            ...
            <div>
              <a href="admin.php?page=kamaryangdipesan&aksi=tambah" class="bg-purple-600 p-2 rounded-lg text-white font-semibold text-sm  ">Tambah Data Pesanan</a>
            </div>
                ...
                <table class="w-full whitespace-no-wrap">
                  ...
                  <tr
                    ...
                    >
                      ...
                      <th class="px-4 py-3">Check_in</th>
                      <th class="px-4 py-3">Check_out</th>
