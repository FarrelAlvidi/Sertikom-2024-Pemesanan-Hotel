...
if (isset($_POST['submit'])) {
    ...
    if ($exc) {
        ...
        document.location= 'admin.php?page=kamaryangdipesan';
        </script>";
    }
...
<body>
    ...
    <div class="shadow-lg w-1/2 ml-52 mt-16 p-5 bg-slate-50">
        <h1 class="text-center font-semibold text-2xl mb-5">Tambah Pesanan</h1>
        <div class="grid">
            <form action="" method="post" autocomplete="off">
                <label class="font-semibold text-gray-400">Nama Lengkap</label> <br>
                <input type="text"  name="nama" class="px-4 w-full border  p-1.5 rounded-md mt-2 mb-3" required>
                <label class="font-semibold text-gray-400">Nomor Identitas</label> <br>
                <input type="number" name="no_id" class="px-4 w-full border p-1.5 rounded-md mt-2 mb-3" required>
                <label class="font-semibold text-gray-400">Nomor Handphone</label> <br>
                <input type="number" name="no_hp" class="px-4 w-full border p-1.5 rounded-md mt-2 mb-3" required>
                <label class="font-semibold text-gray-400">Jumlah Kamar</label> <br>
                <input type="number" name="jumlah_kamar" class="px-4 w-full border  p-1.5 rounded-md mt-2 mb-3" required>
                <label class="font-semibold text-gray-400">Check in</label> <br>
                <input type="date" name="cekin" class="px-4 w-full border  p-1.5 rounded-md mt-2 mb-3" required>
                <label class="font-semibold text-gray-400">Check out</label> <br>
                <input type="date" name="cekout" class="px-4 w-full border  p-1.5 rounded-md mt-2 mb-3  " required>
                <label class="font-semibold text-gray-400">Jenis Kamar</label> <br>
                <select name="jenis_kamar" class="px-4   w-full border  p-1.5 rounded-md mt-2 mb-3  " required>
